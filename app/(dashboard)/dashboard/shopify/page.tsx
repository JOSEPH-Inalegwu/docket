        ...
        <header className="space-y-4">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-[#95BF47]/20 flex items-center justify-center shrink-0">
        ...
        {dataError && (
          ...
          >
            ...
            <div className="min-w-0">
              ...
              <p className="text-sm text-red-700 dark:text-red-300 wrap-break-word">{dataError}</p>
            </div>
          </section>
        )}
